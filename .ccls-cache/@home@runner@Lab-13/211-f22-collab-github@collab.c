...
void aldiocs2_smatro2()
{
  printf("Dio Soetarman and Sivani Matroja\n");
  printf("We learned how to use git and some of the many functions that git has.\n");
  printf("Some of the functions include: clone, status, and push.\n");
}
